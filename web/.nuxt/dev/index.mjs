...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRequestProtocol, getRequestHost, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/maxi/www/curriculum/web/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/maxi/www/curriculum/web/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/maxi/www/curriculum/web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file:///Users/maxi/www/curriculum/web/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/maxi/www/curriculum/web/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/maxi/www/curriculum/web/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/maxi/www/curriculum/web/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/maxi/www/curriculum/web/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/maxi/www/curriculum/web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/maxi/www/curriculum/web/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/maxi/www/curriculum/web/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/maxi/www/curriculum/web/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/maxi/www/curriculum/web/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/maxi/www/curriculum/web/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/maxi/www/curriculum/web/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/maxi/www/curriculum/web/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/maxi/www/curriculum/web/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/maxi/www/curriculum/web/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/maxi/www/curriculum/web/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/maxi/www/curriculum/web/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/maxi/www/curriculum/web/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/maxi/www/curriculum/web/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/maxi/www/curriculum/web/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/maxi/www/curriculum/web/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/maxi/www/curriculum/web/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/maxi/www/curriculum/web/node_modules/unhead/dist/server.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/maxi/www/curriculum/web/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/maxi/www/curriculum/web/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/maxi/www/curriculum/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maxi/www/curriculum/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maxi/www/curriculum/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maxi/www/curriculum/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maxi/www/curriculum/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/maxi/www/curriculum/web/.data/kv"}));
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2026-01-17T15:50:27.022Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
...
const _twa2IJh0SXeJUVIcjcFVTx5F8UMygLNNgfLnxkgnls = (function(nitro) {
...
const _s3j6jmevjZdF7DG7EoMwbLAF9iCRo9zTh1nxq6pKZuk = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "/Users/maxi/www/curriculum/web";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"fr"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
...
const _4iToQuElCxrYxvHGQJiYfeogroaq7KYWmpwHe_g4ITk = (nitroApp) => {
...
const _nyjttfog8_u0UhfvI2yeDlJmv1flORXYheKCTpqa4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _twa2IJh0SXeJUVIcjcFVTx5F8UMygLNNgfLnxkgnls,
_s3j6jmevjZdF7DG7EoMwbLAF9iCRo9zTh1nxq6pKZuk,
_4iToQuElCxrYxvHGQJiYfeogroaq7KYWmpwHe_g4ITk,
_nyjttfog8_u0UhfvI2yeDlJmv1flORXYheKCTpqa4
];
...
const _f3Kbb4 = eventHandler((event) => {
...
const getClientManifest = () => import('file:///Users/maxi/www/curriculum/web/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _0J8049 = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _qFY6mc = eventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/maxi/www/curriculum/web/node_modules/fast-xml-parser/src/fxp.js');
...
const _R_5d4s = defineEventHandler(async (e) => {
...
const _iiMJ8y = defineEventHandler(async (e) => {
...
const _yXJfDl = defineEventHandler(sitemapXmlEventHandler);

const _lazy_jAU9Y8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _f3Kbb4, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_jAU9Y8, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _0J8049, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _qFY6mc, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _R_5d4s, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _iiMJ8y, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _yXJfDl, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jAU9Y8, lazy: true, middleware: false, method: undefined }
];
