...
function HoleBackground({
  ...
  glowColor = '#a900ff',
  gradientColors = ['#00f8f1', '#ffbd1e', '#fe848f'],
  className,
  children,
  ...props
}: HoleBackgroundProps) {
  ...
  return (
    <div
      ...
      style={{
        ['--hole-glow' as string]: glowColor,
        ['--hole-g1' as string]: gradientColors[0],
        ['--hole-g2' as string]: gradientColors[1],
        ['--hole-g3' as string]: gradientColors[2],
      }}
      {...props}
    >
      {children}
      ...
      {/* Glow overlay */}
      <div
        className="content-[''] absolute z-[5] top-1/2 left-1/2 block size-full mix-blend-overlay [transform:translate3d(-50%,-50%,0)]"
        style={{
      ...
      <motion.div
        className="absolute top-[-71.5%] left-1/2 z-[3] w-[30%] h-[140%] rounded-b-full blur-3xl opacity-75 dark:mix-blend-plus-lighter mix-blend-plus-darker [transform:translate3d(-50%,0,0)]"
        style={{
          backgroundImage: `linear-gradient(20deg, ${gradientColors[0]}, ${gradientColors[1]}20 16.5%, ${gradientColors[2]} 33%, ${gradientColors[2]}20 49.5%, ${gradientColors[0]} 66%, ${gradientColors[0]}60 85.5%, ${gradientColors[1]} 100%)`,
