...
// ─── Main component ──────────────────────────────────────────────────────────
export default function V4MonographCold() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-zinc-100 antialiased">
      ...
      <BubbleBackground
        ...
        colors={{
          first: '56,189,248',    // sky-400
          second: '99,102,241',   // indigo-400
          third: '34,211,238',    // cyan-400
          fourth: '29,78,216',    // blue-700
          fifth: '139,92,246',    // violet-400
          sixth: '14,165,233',    // sky-500
        }}
      />
