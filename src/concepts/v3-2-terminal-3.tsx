...
// ─── Main component ──────────────────────────────────────────────────────────
export default function V3Terminal3() {
  ...
  return (
    <div className="relative min-h-screen bg-[#191724] font-mono text-[#e0def4] selection:bg-[#c4a7e7]/20" style={{ fontFamily: "'Space Mono', monospace" }}>
      <Scanlines />
