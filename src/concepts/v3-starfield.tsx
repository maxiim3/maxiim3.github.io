...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <p className="mb-8 text-sm leading-[1.8] text-zinc-400 font-light">
        {description}
      </p>
      ...
      <div className="mb-8 flex flex-wrap gap-2">
        {tech.map((t) => (
          <span
            key={t}
            className="rounded-full border border-white/[0.06] px-3 py-1 text-xs font-light text-zinc-500"
          >
            {t}
          </span>
        ))}
      ...
      <div className="flex items-center justify-between">
        ...
        <a
          ...
          className="flex items-center gap-1.5 text-xs font-light text-zinc-500 uppercase tracking-[0.15em] transition-colors duration-300 hover:text-zinc-200"
        >
          View
...
function ExperienceRow({
  ...
  return (
    <motion.article
      {...fade}
      className="group rounded-xl border border-white/[0.06] bg-white/[0.03] p-8 transition-colors duration-500 hover:border-white/[0.12] hover:bg-white/[0.05]"
    >
      ...
      <p className="text-sm leading-[1.8] text-zinc-400 font-light max-w-2xl">
        {description}
      </p>
    </motion.article>
  );
    ...
    <div className="min-h-screen text-zinc-100">
      ...
      <div className="relative z-10">
        ...
        <section className="relative flex h-screen w-full flex-col items-center justify-center px-6 text-center">
          ...
          >
            <button
              ...
              className="flex items-center gap-2 rounded-full border border-white/15 px-7 py-3 text-xs font-light uppercase tracking-[0.2em] text-zinc-300 hover:border-white/30 hover:text-white transition-colors duration-300 cursor-pointer"
            >
            ...
            <a
              href="/cv.pdf"
              download
              className="flex items-center gap-2 rounded-full border border-white/[0.06] px-7 py-3 text-xs font-light uppercase tracking-[0.2em] text-zinc-600 hover:border-white/15 hover:text-zinc-400 transition-colors duration-300"
            >
        ...
        <Section id="about">
          ...
          <motion.p
            {...fade}
            className="mb-16 text-xl md:text-2xl font-light text-zinc-300 leading-relaxed max-w-2xl"
          >
            {content.about[lang]}
          </motion.p>

          <motion.div {...fade} className="flex flex-wrap gap-16">
            {[
              {
        ...
        <Section id="contact">
          ...
          <motion.div {...fade} className="mb-16">
            <a
              ...
              className="group inline-flex items-center gap-3 text-2xl font-light text-zinc-300 border-b border-white/10 pb-3 transition-colors duration-300 hover:text-white hover:border-white/25"
            >
          ...
          <motion.div {...fade} className="mb-16 flex flex-wrap gap-3">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="flex items-center gap-2.5 rounded-xl border border-white/[0.06] px-5 py-3 text-sm font-light text-zinc-500 transition-colors duration-300 hover:border-white/15 hover:text-zinc-300"
              >
          ...
          <motion.div {...fade}>
            <a
              href="/cv.pdf"
              download
              className="inline-flex items-center gap-3 rounded-full border border-white/[0.08] px-8 py-3.5 text-xs font-light uppercase tracking-[0.2em] text-zinc-400 hover:border-white/20 hover:text-zinc-200 transition-colors duration-500"
            >
              <Download className="h-3.5 w-3.5" />
              {content.cta.downloadCV[lang]}
            </a>
