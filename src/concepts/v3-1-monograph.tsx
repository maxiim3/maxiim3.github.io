...
// ─── Main component ──────────────────────────────────────────────────────────
export default function V3Monograph() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-zinc-100 antialiased">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
        <div className="absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full bg-amber-500/[0.03] blur-[150px]" />
        <div className="absolute top-[55%] -right-60 h-[500px] w-[500px] rounded-full bg-rose-500/[0.025] blur-[140px]" />
        <div className="absolute bottom-[-10%] left-[20%] h-[500px] w-[500px] rounded-full bg-amber-500/[0.03] blur-[130px]" />
      </div>
